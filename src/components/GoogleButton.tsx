...
function GoogleButton({ label, onClick, disabled }: GoogleButtonProps) {
  return (
    <button
      type="button"
    ...
    >
      <svg width="18" height="18" viewBox="0 0 18 18" aria-hidden="true">
        ...
        <path
          fill="#34A853"
          d="M9 18c2.43 0 4.4673-.806 5.9564-2.1805l-2.9087-2.2581c-.8059.54-1.8368.859-3.0477.859-2.3441 0-4.3282-1.5831-5.0359-3.7104H.9573v2.3318C2.4382 15.9832 5.4818 18 9 18z"
        />
        <path
          fill="#FBBC05"
